...
export default function Categories() {
  return (
    <section className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-md">
      <Link href="/restaurants" prefetch={false} className="bg-white p-md rounded-2xl flex flex-col items-center justify-center shadow-sm border border-slate-100 transition-all active:scale-95 cursor-pointer">
      ...
      <Link href="/grocery" prefetch={false} className="bg-white p-md rounded-2xl flex flex-col items-center justify-center shadow-sm border border-slate-100 transition-all active:scale-95 cursor-pointer">
