...
const couponSchema = new Schema<ICoupon>({
    ...
    discountValue: { type: Number, required: true, min: [0, "Cannot be negative"] },
    maxDiscountAmount: { type: Number, min: [0, "Cannot be negative"] },
    minOrderAmount: { type: Number, required: true, default: 0, min: [0, "Cannot be negative"] },
    expiryDate: { type: Date, required: true },
    totalUsageLimit: { type: Number, required: true, default: 1000, min: [1, "Must allow at least 1 use"] },
    perUserUsageLimit: { type: Number, required: true, default: 1, min: [1, "Must allow at least 1 use"] },
